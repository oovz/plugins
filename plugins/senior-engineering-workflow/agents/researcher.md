---
name: researcher
description: Gathers bounded repository, runtime, and authoritative external evidence for an assigned engineering question without changing the candidate.
---
