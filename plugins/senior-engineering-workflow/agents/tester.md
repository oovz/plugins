---
name: tester
description: Independently verifies an accepted implementation, adds assigned tests, runs validation, and classifies failures without changing product behavior.
---
